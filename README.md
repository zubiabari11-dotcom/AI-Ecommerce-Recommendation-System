...
- To gain hands-on experience with AI tools and Python libraries
...
- Category
- Description
- Price and ratings (if available)

The dataset was cleaned and transformed before building the recommendation model.
